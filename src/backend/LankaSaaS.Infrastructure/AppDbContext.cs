...
{
    public DbSet<PlatformUser> PlatformUsers => Set<PlatformUser>(); public DbSet<PlatformAuditEvent> PlatformAuditEvents => Set<PlatformAuditEvent>();
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<PlatformUser>().HasIndex(x=>x.Email).IsUnique(); b.Entity<PlatformAuditEvent>().HasIndex(x=>new{x.TargetTenantId,x.CreatedAt}); b.Entity<PlatformAuditEvent>().HasIndex(x=>new{x.PlatformUserId,x.CreatedAt});
