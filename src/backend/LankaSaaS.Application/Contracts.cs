...
public record PlatformTenantDto(Guid Id,string BusinessName,string Email,string Plan,string Status,int UserLimit,int ActiveUsers,DateTimeOffset? TrialEndsAt,DateTimeOffset? SubscriptionEndsAt,DateTimeOffset? GraceEndsAt,DateTimeOffset CreatedAt);
