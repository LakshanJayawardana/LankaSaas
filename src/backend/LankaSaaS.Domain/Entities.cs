...
public sealed class Expense : Entity, ITenantOwned { public Guid TenantId { get; set; } public Guid? EventId { get; set; } public Guid? PurchaseOrderId { get; set; } public Guid? EventStaffAssignmentId { get; set; } public required string Description { get; set; } public decimal Amount { get; set; } public DateOnly ExpenseDate { get; set; } public required string Category { get; set; } }
...
public sealed class LedgerAccount : Entity, ITenantOwned { public Guid TenantId { get; set; } public required string Code { get; set; } public required string Name { get; set; } public required string Type { get; set; } public bool IsSystem { get; set; } public bool IsActive { get; set; }=true; }
public sealed class JournalEntry : Entity, ITenantOwned { public Guid TenantId { get; set; } public DateOnly EntryDate { get; set; } public required string Description { get; set; } public string? Reference { get; set; } public Guid? EventId { get; set; } public required string SourceType { get; set; } public Guid SourceId { get; set; } public List<JournalLine> Lines { get; set; }=[]; }
public sealed class JournalLine : Entity, ITenantOwned { public Guid TenantId { get; set; } public Guid JournalEntryId { get; set; } public Guid AccountId { get; set; } public required string AccountCode { get; set; } public required string AccountName { get; set; } public decimal Debit { get; set; } public decimal Credit { get; set; } }
public sealed class EventStaffAssignment : Entity, ITenantOwned { public Guid TenantId { get; set; } public Guid EventId { get; set; } public Guid UserId { get; set; } public required string StaffName { get; set; } public required string Responsibility { get; set; } public DateTimeOffset ShiftStartsAt { get; set; } public DateTimeOffset ShiftEndsAt { get; set; } public decimal HourlyRate { get; set; } public string Status { get; set; }=StaffingStatuses.Scheduled; public DateTimeOffset? CheckedInAt { get; set; } public DateTimeOffset? CheckedOutAt { get; set; } public decimal ActualHours { get; set; } public decimal ActualCost { get; set; } public string? Notes { get; set; } }
public sealed class AuditEvent : Entity, ITenantOwned { public Guid TenantId { get; set; } public Guid UserId { get; set; } public required string Method { get; set; } public required string Path { get; set; } public int StatusCode { get; set; } public required string CorrelationId { get; set; } public string? IpAddress { get; set; } }
...
public static class AccountTypes { public const string Asset="Asset"; public const string Liability="Liability"; public const string Equity="Equity"; public const string Revenue="Revenue"; public const string Expense="Expense"; }
public static class SystemAccountCodes { public const string Cash="1000"; public const string Receivables="1100"; public const string Payables="2000"; public const string EventRevenue="4000"; public const string EventExpenses="5000"; }
public static class StaffingStatuses { public const string Scheduled="Scheduled"; public const string CheckedIn="CheckedIn"; public const string Completed="Completed"; public const string Cancelled="Cancelled"; }
